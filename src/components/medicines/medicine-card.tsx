...
import { Calendar, MapPin, PackageCheck, AlertCircle, Edit, Trash } from 'lucide-react'; // Added Edit and Trash icons
    ...
    <Card className="h-full flex flex-col">
      ...
      <CardFooter className="pt-0 pb-4">
        <div className="flex space-x-2 w-full">
          <Button variant="outline" className="flex-1" as={Link} to={`/medicines/${medicine.id}`}>
            Details
          </Button>
